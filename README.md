...
The ghubenorm is the crawler that I developed on my postdoc that can visit github projects, identify ORM configurations for Java/Ruby, and infer the data models from source code, storing on a database for further analysis.
